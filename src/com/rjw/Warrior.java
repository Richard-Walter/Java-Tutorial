...
//    public Teleports teleportType;
    ...
    // The constructor is called to create a new Warrior object
    public Warrior() {

    }

    // You can have constructors with and without attributes
    ...
    // Model what happens when a warrior attacks and blocks
    public int attack() {
    ...
    // Getters and setters provide access to private, or protected fields
...
// ---- INTERFACE ADD ON ----
// Have teleportType handle output depending on settings
