...
// Battle is a utility class so it contains only static methods

// Static methods and fields should be used when it doesn't make sense
// for a real world object to be able to perform and action, or when values
...
public class Battle {
    ...
    public static void startFight(Warrior w1,
        ...
        // Loop giving each a chance to attack and block
        while (true) {
